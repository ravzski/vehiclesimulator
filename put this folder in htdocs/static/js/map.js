var simulation_manager = (function(){
    ...
    var config = (function(){
        var params = {
            center_start: new google.maps.LatLng(14.599512,120.984219),
            zoom_start: 13,
            zoom_follow: 17,
            zoom_station: 15,
            ...
            json_paths: {
                edges: 'static/database/paths.json',
                stations: 'static/database/checkpoint.json',
                vehicles: 'static/database/vehicle.json',
                station_vehicles: 'static/database/fill.json'
            }
        };
